...
class MempoolEntry {
  ...
  static fromTX(tx, view, height, rbf) {
    return new this().fromTX(tx, view, height, rbf);
  }
  ...
  toRaw() {
    ...
    bw.writeU8(this.rbf ? 1 : 0);
    console.log('entry toRaw end')
    return bw.render();
  }
